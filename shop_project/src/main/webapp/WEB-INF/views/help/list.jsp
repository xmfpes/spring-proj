...
<div class="bs-docs-header" id="content" tabindex="-1" style="position:relative;padding:30px 0;background-image:-webkit-linear-gradient(top,#563d7c 0,#6f5499 100%);"> 
	<div class="container"> 
		<h1 style="font-size:50px;color:#FFFFFF">고객센터</h1>
	...
	<div class="col-md-12 col-xs-12">
		...
		<div class="box">
			<div class="nav" role="navigation">
                <a href="/help/register" id="newBtn" class="create btn btn-success btn-wide pull-right"><i class="fa fa-pencil"></i> 새 글 쓰기</a>   
                <h4>고객센터</h4>
				...
				<table class="table table-bordered">
					...
					<c:forEach items="${list}" var="boardVO">
						<tr>
							<td>${boardVO.bno }</td>
							<td>
								<a href='/help/readPage${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${boardVO.bno }'>
									${boardVO.title }
